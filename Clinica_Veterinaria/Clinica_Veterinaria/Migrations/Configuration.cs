namespace Clinica_Veterinaria.Migrations
{
    using Models;
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Clinica_Veterinaria.Models.VetsDB>
    {
        ...
        protected override void Seed(Clinica_Veterinaria.Models.VetsDB context)
        {
            ...
            var donos = new List<Donos> {
                ...
                new Donos  {DonoID=2, Nome = "Andreia Gomes", NIF ="854613462", UserName="a@a.aa"},
